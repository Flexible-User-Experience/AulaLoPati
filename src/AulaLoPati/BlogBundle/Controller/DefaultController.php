...
class DefaultController extends Controller
{
    ...
    public function jornadaAction($titol)
    {
        ...
        return $this->render(
            'BlogBundle:Default:jornada.html.twig',
            array(
                'jornada'   => $jornada,
                'ponencies' => $ponencies
            )
    ...
    public function projecteAction($titol)
    {
        ...
        return $this->render(
            'BlogBundle:Default:projecte.html.twig',
            array(
                'projecte'   => $projecte,
        ...
        if ($request->getMethod() == 'POST') {
            ...
            if ($form->isValid()) {
                ...
                $this->get('session')->setFlash(
                    'notice',
                    'Gràcies per contactar amb nosaltres, ens posarem amb contacte el més aviat possible.'
                );

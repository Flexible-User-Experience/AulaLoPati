...
/**
 * @ORM\Entity(repositoryClass="AulaLoPati\BlogBundle\Repository\ActivitatRepository")
...
class Activitat {
	...
	public function setProjecte(\AulaLoPati\BlogBundle\Entity\Projecte $projecte = null)
	{
	...
	public function setCategoria(\AulaLoPati\BlogBundle\Entity\CategoriaProjectes $categoria = null)
	{

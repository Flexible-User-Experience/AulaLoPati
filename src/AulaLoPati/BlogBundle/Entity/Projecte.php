...
/**
 * @ORM\Entity(repositoryClass="AulaLoPati\BlogBundle\Repository\ProjecteRepository")
...
class Projecte {
	...
	/**
	 * @ORM\OneToMany(targetEntity="AulaLoPati\BlogBundle\Entity\Activitat", mappedBy="projecte", cascade={"persist", "remove"} )
